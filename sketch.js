...
var pathImg,boyImg,cashImg,diamondsImg,jewelryImg,swordImg,GameOverImg, boyfImg;
...
function preload(){
  ...
  boyfImg = loadAnimation("boyf.png");
  sonido = loadSound("sonido.mp4");
  sonido.loop();
}
...
boy.addAnimation("perdiste", boyfImg);
boy.scale=0.08;
  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      if(swordGroup.isTouching(boy)) {
        ...
        boy.changeAnimation("perdiste", boyfImg);
        boy.scale = 0.8;
